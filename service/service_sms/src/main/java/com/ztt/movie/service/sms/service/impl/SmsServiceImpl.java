package com.ztt.movie.service.sms.service.impl;
...
public class SmsServiceImpl implements SmsService {
    ...
    public void send(String mobile, String checkCode) throws com.aliyuncs.exceptions.ClientException {
        ...
        if ("isv.BUSINESS_LIMIT_CONTROL".equals(code)) {
            ...
            throw new MovieException(ResultCodeEnum.SMS_SEND_ERROR_BUSINESS_LIMIT_CONTROL);
        }

        if (!"OK".equals(code)) {
            log.error("短信发送失败 " + " - code: " + code + ", message: " + message);
            throw new MovieException(ResultCodeEnum.SMS_SEND_ERROR);
        }
    }
}