package com.ztt.movie.service.vod.controller;
...
public class MediaController {
    ...
    public R uploadVideo(
        ...
        try {
            ...
            throw new MovieException(ResultCodeEnum.VIDEO_UPLOAD_TOMCAT_ERROR);
        }
    ...
    public R removeVideo(
        ...
        try {
            ...
            log.error(ExceptionUtils.getMessage(e));
            throw new MovieException(ResultCodeEnum.VIDEO_DELETE_ALIYUN_ERROR);
        }
    }
